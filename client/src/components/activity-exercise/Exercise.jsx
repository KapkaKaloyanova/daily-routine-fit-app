          ...
          <div className="row">
            <div className="col-md-4">
              <div id="ho_shad" className="activity_box text_align_left">
                ...
                <p>
                  Build beautiful length to your spine while calming your mind
                  through a series of flowing exercises that strengthens your
            ...
            <div className="col-md-4">
              <div id="ho_shad" className="activity_box text_align_left">
                ...
                <p>
                  Prevent any future injury, back pain and balance issues
                  through a series of stretching exercises that focus on your
                  lower body and core.
                </p>
